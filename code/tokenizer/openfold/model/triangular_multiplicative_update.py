...
class TriangleMultiplicativeUpdate(nn.Module):
    ...
    def forward(self, 
        ...
        a = self.linear_a_p(z) * self.sigmoid(self.linear_a_g(z)) # [*, N, N, hid]
        a = a * mask
        b = self.linear_b_p(z) * self.sigmoid(self.linear_b_g(z)) # [*, N, N, hid]
        b = b * mask
        x = self._combine_projections(a, b) # [*, N, N, hid]
        x = self.layer_norm_out(x)
        x = self.linear_z(x) # [*, N, N, C_z]
        g = self.sigmoid(self.linear_g(z)) # [*, N, N, C_z]
        z = x * g
